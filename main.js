...
const datas =[
    ...
    },
    {
        "categorie": "cuisine",
        "name": "frigo-top",
        "content/img": "refrigerateur-top4.png",
    ...
    },
    {
        ...
        "content/title": "Congélateur coffre (poyen)",
        "content/val": 0.75
    },
    {
        "categorie": "autres",
        "name": "congelateur-p",
        "content/img": "congelateur-3.png",
        "content/title": "Congélateur coffre (grand)",
        "content/val": 1
    },
    {
...
jQuery(document).ready(function($) {
  ...
  */
  var tab;
  var digitNb = $n=> {
    var v = (typeof $n === 'number') ? String($n) : $n;
    return (v).padStart(4, '0');//digt : if 1 > 0001, if 10 > 0010, if 100 > 0100, ...
  };
  function cleanArray(array) {
    console.log('cleanArray : ',[...new Set(array)]);
    ...
    $(window).on('beforeunload',function (e) {
      ...
      $('#Tabs .item').each(function () {
        if ($(this).find('.qtyvalue').val() > 0) {
          laLabel = $(this).attr('id');
          labelVolume.push(laLabel);
          laValue = $(this).find('.qtyvalue').val();
